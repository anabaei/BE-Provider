...
func (b BookModel) Get(id int64) error {
  ...
  query := `
  SELECT id, createdAt, published, pages, genres, rating, version
  FROM books
  WHERE id=$1`
...
func (b BookModel) Update(book *Book) error {
    query := `UPDATE books SET title=$1, published=$2, pages=$3
    genres=$4, rating=$5, version= version +1
